#
# Copyright (C) 2013-2020 The TeamWin Recovery Project
#
#
...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/klte/recovery.fstab
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/klte/prebuilt/zImage
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/klte/prebuilt/dtb.img
